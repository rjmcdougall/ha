...
from esphome.components import sensor, switch, climate
...
MideaRS485Component = midea_rs485_ns.class_(
    "MideaRS485Component", climate.Climate, cg.PollingComponent
)
...
CONFIG_SCHEMA = climate.climate_schema(MideaRS485Component).extend(
    {
        ...
        cv.Optional(CONF_T1_TEMP): _temp_sensor_schema(),
        cv.Optional(CONF_T2A_TEMP): _temp_sensor_schema(),
        cv.Optional(CONF_T2B_TEMP): _temp_sensor_schema(),
        cv.Optional(CONF_T3_TEMP): _temp_sensor_schema(),
